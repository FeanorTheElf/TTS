...
export class AudioManager {
    ...
    constructor() {
        this.sounds = {
            continue: new Audio((currentConfig && currentConfig.soundUrls.continue) || "continue.wav"),
            finished: new Audio((currentConfig && currentConfig.soundUrls.finished) || "finished.wav")
        };
